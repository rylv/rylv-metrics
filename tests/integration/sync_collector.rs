...
fn test_build_collector() -> std::io::Result<()> {
    ...
    collector.histogram(
        ...
        &mut [
            RylvTag::from_static("tag:value"),
            RylvTag::from_static("tag2:value3"),
        ],
    );
...
fn test_linux_batch_writer() -> std::io::Result<()> {
    ...
    collector.histogram(
        ...
        100,
        &mut [RylvTag::from_static("batch:enabled")],
    );
    collector.histogram(
        RylvStr::from_static("test.linux.batch"),
        200,
        &mut [RylvTag::from_static("batch:test")],
    );
...
fn test_apple_batch_writer() -> std::io::Result<()> {
    ...
    collector.histogram(
        ...
        50,
        &mut [RylvTag::from_static("platform:macos")],
    );
    collector.histogram(
        RylvStr::from_static("test.apple.batch"),
        75,
        &mut [RylvTag::from_static("platform:ios")],
    );
...
fn test_linux_batch_counter_methods() -> std::io::Result<()> {
    ...
    collector.count(
        ...
        &mut [RylvTag::from_static("batch:sendmmsg")],
    );
    collector.count_add(
    ...
    collector.gauge_avg(
        ...
        85,
        &mut [RylvTag::from_static("core:0")],
    );
...
fn test_apple_batch_counter_methods() -> std::io::Result<()> {
    ...
    collector.count(
        ...
        &mut [RylvTag::from_static("batch:sendmsg_x")],
    );
    collector.count_add(
    ...
    collector.gauge_avg(
        ...
        65,
        &mut [RylvTag::from_static("sensor:cpu")],
    );
...
fn test_simple_writer_mixed_methods() -> std::io::Result<()> {
    ...
    collector.count(
        ...
        &mut [RylvTag::from_static("type:500")],
    );
    collector.count_add(
        RylvStr::from_static("throughput"),
        10000,
        &mut [RylvTag::from_static("unit:bytes")],
    );
    collector.gauge_avg(
...
fn test_linux_batch_mixed_methods() -> std::io::Result<()> {
    ...
    collector.count_add(
        ...
        5120,
        &mut [RylvTag::from_static("proto:http")],
    );
    collector.gauge_avg(
        RylvStr::from_static("active.users"),
        123,
        &mut [RylvTag::from_static("region:us-east")],
    );
...
fn test_apple_batch_mixed_methods() -> std::io::Result<()> {
    ...
    collector.histogram(
        ...
        16,
        &mut [RylvTag::from_static("view:main")],
    );
    collector.count(
        RylvStr::from_static("gestures.tap"),
        &mut [RylvTag::from_static("screen:home")],
    );
    collector.count_add(
        RylvStr::from_static("pixels.drawn"),
        1920000,
        &mut [RylvTag::from_static("resolution:1080p")],
    );
    collector.gauge_avg(
        RylvStr::from_static("battery.level"),
        87,
        &mut [RylvTag::from_static("device:iphone")],
    );
...
fn test_simple_writer_counter_aggregation() -> std::io::Result<()> {
    ...
    collector.count_add(
        ...
        100,
        &mut [RylvTag::from_static("protocol:tcp")],
    );
    collector.count_add(
        RylvStr::from_static("data.transferred"),
        200,
...
fn test_linux_batch_counter_aggregation() -> std::io::Result<()> {
    ...
    for _ in 0..5 {
        collector.count(
            ...
            &mut [RylvTag::from_static("iface:eth0")],
        );
    }
...
fn test_linux_batch_histogram_aggregation() -> std::io::Result<()> {
    ...
    for &val in &values {
        collector.histogram(
            ...
            val,
            &mut [RylvTag::from_static("db:postgres")],
        );
    }
...
fn test_apple_batch_counter_aggregation() -> std::io::Result<()> {
    ...
    for _ in 0..6 {
        collector.count(
            ...
            &mut [RylvTag::from_static("button:submit")],
        );
    }
    ...
    collector.count_add(
        ...
        256,
        &mut [RylvTag::from_static("type:image")],
    );
    collector.count_add(
        RylvStr::from_static("macos.file.size"),
        512,
...
fn test_apple_batch_histogram_aggregation() -> std::io::Result<()> {
    ...
    for &val in &values {
        collector.histogram(
            ...
            val,
            &mut [RylvTag::from_static("scene:menu")],
        );
    }
...
fn test_simple_writer_heavy_aggregation() -> std::io::Result<()> {
    ...
    for i in 1..=50 {
        collector.count(
            ...
            &mut [RylvTag::from_static("load:test")],
        );
        collector.histogram(
...
fn test_linux_batch_heavy_aggregation() -> std::io::Result<()> {
    ...
    for i in 1..=100 {
        collector.count(
            ...
            &mut [RylvTag::from_static("test:sendmmsg")],
        );
        if i % 2 == 0 {
            collector.histogram(
...
fn test_apple_batch_heavy_aggregation() -> std::io::Result<()> {
    ...
    for i in 1..=100 {
        collector.count(
            ...
            &mut [RylvTag::from_static("test:sendmsg_x")],
        );
        if i % 3 == 0 {
            collector.histogram(
